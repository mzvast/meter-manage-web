...
angular.module('manageApp')
  .component('quickSelectUserComponent', {
    templateUrl: 'scripts/components/shared/quickSelectUser/component.html',
    bindings: {
      onAdd: '&',
      basket: '<'
    },
    controller: quickSelectUser
  });

quickSelectUser.$inject = ['userService','modelService','tabService'];

function quickSelectUser(userService,modelService,tabService) {
  var $ctrl = this;

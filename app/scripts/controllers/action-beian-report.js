...
angular.module('manageApp')
  .controller('ActionBeianReportCtrl', ActionBeianReportCtrl);

ActionBeianReportCtrl.$inject = ['$window','$scope','beianManager','dataManager'];

function ActionBeianReportCtrl($window,$scope,_beianManager,_dataManager)  {
  var vm = this;
  vm.awesomeThings = [
    'HTML5 Boilerplate',
    'AngularJS',

...
angular.module('manageApp')
  .controller('ActionBeianCompareCtrl', ActionBeianCompareCtrl);

ActionBeianCompareCtrl.$inject = ['$scope', 'beianManager', '$state', '$interval'];

function ActionBeianCompareCtrl($scope, _beianManager, $state, $interval) {
  var vm = this;
  vm.awesomeThings = [
    'HTML5 Boilerplate',
    'AngularJS',

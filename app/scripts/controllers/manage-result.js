...
angular.module('manageApp')
  .controller('ManageResultCtrl', ManageResultCtrl);

ManageResultCtrl.$inject = ['$scope','$state','$stateParams','dataManager','beianManager'];

function ManageResultCtrl($scope,$state,$stateParams,_dataManager,_beianManager) {
  var vm = this;
  vm.awesomeThings = [
    'HTML5 Boilerplate',
    'AngularJS',

...
describe('Service: dataManager', function() {
    ...
    it('R|getRequirements should get Requirements ', inject(function($httpBackend){
      dataManager.requirements.get({ current_page: 1, items_per_page: 10, order_by: 'id', reverse: true, type:0 });
        $httpBackend
            .expect('GET',
                '/api/v2/requirements?current_page=1&items_per_page=10&order_by=id&reverse=true&type=0')
            .respond(200, {
                hello: 'content'
            });
        $httpBackend.flush();
